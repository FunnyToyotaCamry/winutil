...
function Invoke-WPFButton {
    ...
    #[System.Windows.MessageBox]::Show("$Button","RicePot's Windows Utility","OK","Info")
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="RicePot Windows Utility" Height="800" Width="1200">
        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="50" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPIL6XbvyLgSPUvczeuWGmu-4O9OnMTr6WbWI7XInH&s" Margin="0,10,0,10"/>
